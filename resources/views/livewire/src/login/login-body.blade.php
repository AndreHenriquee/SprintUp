<div class="container mt-5 pt-5" id="background">
    <div class="row">
        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                ...
                <input type="email" wire:model="email" class="form-control mt-4" placeholder="Usuário" />
                @error('email') <span class="text-danger error">{{ 'Campo obrigatório' }}</span>@enderror 
                <input type="password" wire:model="senha" class="form-control mt-4" placeholder="Senha" />
                @error('senha') <span class="text-danger error">{{ 'Campo obrigatório' }}</span>@enderror 
