            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        <a href="/membros-equipe/{{$userTeam->id}}" title="Ver membros da equipe" class="text-dark me-3" style="cursor:pointer; text-decoration: none;">
                        ...
                        <a href="/squads-equipe/{{$userTeam->id}}" title="Ver Squads da equipe" class="text-dark" style="cursor:pointer; text-decoration: none;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
