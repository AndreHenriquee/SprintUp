<div class="container">
    @if($teamDataAndPermission['cargo'] != "ST")
        <div class="modal-content">
            <div title="{{$teamDataAndPermission['squad_nome']}}" class="h2 col-6 pe-3 p-3 ">
                Crie uma tarefa para {{$teamDataAndPermission['squad_nome']}}
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" wire:model="descricao" rows="15" style="background-color:rgba(195, 195, 195, 0.35);border:none;resize:none"></textarea>
                    </div>
    ...
    @else
        <div class="alert alert-warning mt-5" role="alert">
            Você não tem acesso a esta funcionalidade.</br></br>
